...
export default function ContratoSlide() {
  const features = ["Preenchimento inteligente", "Assinatura digital integrada", "Termos jurídicos blindados"];
    ...
    <div className="w-full h-full flex flex-col items-center justify-center px-6 bg-light">
      <div className="slide-feature-row max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          >
            Venda ou Consignação formalizadas em minutos. Os contratos puxam os dados do veículo e do cliente sozinhos.
          </motion.p>
