...
export default function HeroSlide() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative px-6 py-20 bg-light">
      ...
      >
        <span className="uppercase tracking-widest text-[10px]">Role para avançar</span>
