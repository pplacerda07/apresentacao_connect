...
export default function DRESlide() {
  const features = ["Cálculo automático de comissão", "Despesas atreladas à placa", "Fluxo de caixa em tempo real"];
    ...
    <div className="w-full h-full flex flex-col items-center justify-center px-6 bg-light">
      <div className="max-w-6xl mx-auto w-full flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          >
            Veja o lucro real de cada operação. Saiba exatamente de onde o dinheiro vem e para onde ele vai, centavo por centavo.
          </motion.p>
